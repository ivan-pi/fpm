module fpm_meta_request

    use fpm_error, only: error_t, fatal_error, syntax_error
    use fpm_toml, only : toml_table, toml_key, get_value

    implicit none
    private

    public :: metapackage_request_t, new_meta_request, is_meta_package
