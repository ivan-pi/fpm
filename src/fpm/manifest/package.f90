...
!>[extra]
!>```
submodule (fpm_manifest) fpm_manifest_package
...
contains
   ...
   module function package_is_same(this,that)
      class(package_config_t), intent(in) :: this
      class(serializable_t), intent(in) :: that
      logical :: package_is_same
...
end submodule fpm_manifest_package
