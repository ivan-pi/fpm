submodule (fpm_meta) fpm_meta_impl
...
use fpm_manifest, only: dependency_config_t
...
integer, parameter :: LANG_FORTRAN = 1
integer, parameter :: LANG_C       = 2
integer, parameter :: LANG_CXX     = 3
