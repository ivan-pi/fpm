submodule (fpm_model) fpm_model_impl

use fpm_compiler, only: debug
use fpm_strings, only: str, len_trim, upper, operator(==)
use fpm_toml, only: toml_stat, set_value, set_list, get_value, &
