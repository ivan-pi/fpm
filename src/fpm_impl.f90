...
use fpm_strings, only: string_t, str_ends_with, lower, join, &
                       is_valid_module_name, len_trim, operator(.in.), string_cat
...
use fpm_error, only: fatal_error, fpm_stop
